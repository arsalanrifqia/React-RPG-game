...
export const LOOT_POOL: Item[] = [
  { id: "item_1", name: "Iron Broadsword", type: "weapon", rarity: "Common", stats: { strength: 5, attack: 15 }, value: 50, description: "A standard military blade." },
  { id: "item_2", name: "Steel Greatsword", type: "weapon", rarity: "Uncommon", stats: { strength: 12, agility: 3, attack: 28 }, value: 150, description: "Heavy and sharp steel." },
  { id: "item_3", name: "Flame Tongue Blade", type: "weapon", rarity: "Rare", stats: { strength: 22, intelligence: 10, attack: 45 }, value: 400, description: "Radiates with magical embers." },
  { id: "item_4", name: "Apprentice Wand", type: "weapon", rarity: "Common", stats: { intelligence: 6, attack: 12 }, value: 50, description: "Channels minor magical sparks." },
  { id: "item_5", name: "Archmage Staff", type: "weapon", rarity: "Epic", stats: { intelligence: 35, mana: 50, attack: 30 }, value: 850, description: "Imbued with ancient celestial energies." },
  { id: "item_6", name: "Shadow Dagger", type: "weapon", rarity: "Uncommon", stats: { agility: 10, strength: 4, attack: 20 }, value: 140, description: "Silent and deadly." },
  { id: "item_7", name: "Assassin Stiletto", type: "weapon", rarity: "Rare", stats: { agility: 25, attack: 35 }, value: 420, description: "Swift executioner weapon." },
...
export function generateRandomLoot(floor: number): Item {
  const rarities: ("Common" | "Uncommon" | "Rare" | "Epic" | "Legendary")[] = floor >= 4 ? ["Uncommon", "Rare", "Epic", "Legendary"] : floor >= 2 ? ["Common", "Uncommon", "Rare", "Epic"] : ["Common", "Uncommon", "Rare"];
