    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col relative overflow-hidden">
      ...
      <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md px-6 py-4 flex justify-between items-center z-20">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-lg bg-gradient-to-r from-amber-400 to-purple-300 bg-clip-text text-transparent">
              Realm of Legends
            </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="p-2.5 bg-slate-800 hover:bg-slate-700 rounded-xl border border-slate-700 text-slate-200 transition-colors cursor-pointer relative"
            title="Open Chat"
          >
          ...
          <button
            onClick={onLogout}
            className="p-2.5 bg-slate-800 hover:bg-red-950/50 hover:text-red-400 rounded-xl border border-slate-700 text-slate-200 transition-colors cursor-pointer"
            title="Logout"
          >
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-6 z-10">
        ...
        <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-6 shadow-2xl backdrop-blur-md flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-amber-400 font-semibold">{character.className} • Level {character.level}</p>
                <div className="text-[11px] text-slate-400 mt-1">EXP: {character.exp} / {character.expToNext}</div>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {character.statPoints > 0 && (
                    <button
                      ...
                      className="w-6 h-6 bg-amber-500 hover:bg-amber-400 text-slate-950 rounded-lg flex items-center justify-center font-bold text-xs cursor-pointer"
                    >
                      +
                    </button>
                  )}
              ...
              <div className="flex justify-between items-center bg-slate-950/70 p-3 rounded-xl border border-slate-800/80">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {character.statPoints > 0 && (
                    <button
                      onClick={() => onAllocateStat('intelligence')}
                      className="w-6 h-6 bg-blue-500 hover:bg-blue-400 text-slate-950 rounded-lg flex items-center justify-center font-bold text-xs cursor-pointer"
                    >
                      +
                    </button>
                  )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  {character.statPoints > 0 && (
                    <button
                      ...
                      className="w-6 h-6 bg-emerald-500 hover:bg-emerald-400 text-slate-950 rounded-lg flex items-center justify-center font-bold text-xs cursor-pointer"
                    >
                      +
                    </button>
                  )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  {character.statPoints > 0 && (
                    <button
                      ...
                      className="w-6 h-6 bg-rose-500 hover:bg-rose-400 text-slate-950 rounded-lg flex items-center justify-center font-bold text-xs cursor-pointer"
                    >
                      +
                    </button>
                  )}
            ...
            {character.statPoints > 0 && (
              <div className="p-3 bg-amber-950/50 border border-amber-500/50 rounded-xl text-center text-xs text-amber-300 font-semibold animate-pulse">
                You have {character.statPoints} unspent Stat Point(s)!
              </div>
            )}
          </div>
          ...
          <button
            ...
            className="w-full py-3 bg-slate-800 hover:bg-slate-700 text-slate-200 font-semibold rounded-xl border border-slate-700 transition-all flex items-center justify-center gap-2 cursor-pointer mt-4"
          >
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6 content-start">
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-400 mt-2 leading-relaxed">
                Venture into treacherous crypts and fiery citadels. Play solo or party up in co-op mode with real-time room syncing.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-400 mt-2 leading-relaxed">
                Test your combat prowess against rival champions in tactical real-time multiplayer duels.
              </p>
            </div>
          ...
          <div
            onClick={onOpenShop}
            className="bg-slate-900/90 border border-slate-800 hover:border-slate-700 rounded-3xl p-6 shadow-xl transition-all cursor-pointer group flex flex-col justify-between"
          >
            <div>
              ...
              <p className="text-xs text-slate-400 mt-2">
                Acquire health potions, elixirs, and rare gear provisions with your earned coins.
              </p>
            </div>
          ...
          >
            <div>
              ...
              <p className="text-xs text-slate-400 mt-2">
                Check top-ranked heroes and legendary players across the realm.
              </p>
            </div>
